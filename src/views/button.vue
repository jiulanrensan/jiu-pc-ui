<template>
  <div>
    ...
    <br>
    <br>
    <j-button round>点击</j-button>
    <j-button type="primary" round>点击</j-button>
    <j-button type="success" round>点击</j-button>
    <j-button type="warning" round>点击</j-button>
    <j-button type="danger" round>点击</j-button>
    <j-button type="info" round>点击</j-button>
    <br>
    <br>
    <j-button size="small">点击</j-button>
    <j-button size="medium">点击</j-button>
    <j-button size="large">点击</j-button>
    <br>
    <br>
    <j-button type="text">点击</j-button>
    <br>
    <br>
    <j-button type="text" disabled>点击</j-button>
    <j-button disabled>点击</j-button>
    <j-button type="primary" disabled>点击</j-button>
    <j-button type="success" disabled>点击</j-button>
